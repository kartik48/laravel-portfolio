...
return [
    // --- AI Agent Projects ---
    [
        'title' => '✈️ Flight Price Tracker Agent',
        'description' => "A Claude-based agent that watches airfare for a chosen route and date. Every morning at 8am it pulls the current price, checks it against previous days, and gives a plain buy, sell, or hold call so I know whether to book now or keep waiting.",
        'thumbnail' => 'https://placehold.co/600x400/0a0a0a/dc2626?text=Flight+Price+Tracker',
        'link' => null,
        'tags' => ['Claude', 'AI Agents', 'Python', 'Price Tracking'],
        'category' => 'ai-agents'
    ],
    [
        'title' => '💰 Personal Finance Manager Agent',
        'description' => "A Claude Haiku agent for tracking my own money. I feed it bills, receipts, and manual entries, and it turns them into a monthly view of my spending so I can see where it's going and manage it better.",
        'thumbnail' => 'https://placehold.co/600x400/0a0a0a/dc2626?text=Finance+Manager+Agent',
        'link' => null,
        'tags' => ['Claude Haiku', 'AI Agents', 'Personal Finance'],
        'category' => 'ai-agents'
    ],
